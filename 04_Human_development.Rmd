...
The relationship between university scores and HDI is unclear. However, a clear pattern emerges if we look at university score _per capita_, correcting for country population size. There seems to be an exponential relationship between HDI and university score per capita. Notably, Switzerland is comes out on top due to its small country size and comparatively high number of quality universities.

![](img/hdi-uni-score-pmc-2017.png)
